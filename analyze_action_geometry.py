...
from module.models import InverseDynamicsTransformer, VectorQuantizer, build_frame_encoder_from_config
...
def build_models(
    *,
    ...
    id_depth: int,
    id_mlp_dim: int,
) -> tuple[torch.nn.Module, InverseDynamicsTransformer, VectorQuantizer]:
